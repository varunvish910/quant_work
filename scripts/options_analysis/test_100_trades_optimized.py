#!/usr/bin/env python3
"""
Test quote window approach with 100 SPY trades - OPTIMIZED
Using ±10 second window instead of ±1 second
"""
...
print("="*80)
print("TESTING QUOTE WINDOW WITH 100 SPY TRADES (OPTIMIZED)")
print("Using ±10 second window (was ±1 second)")
print("="*80)
...
print(f"   Using ±10 second time window around each trade (was ±1 second)")
...
for idx, trade in trades.iterrows():
    ...
    # Time window: ±10 seconds (was ±1 second)
    window_start = timestamp_ns - 10_000_000_000  # 10 seconds before
    window_end = timestamp_ns + 10_000_000_000    # 10 seconds after
...
print(f"\n🔄 Comparison with ±1 second window:")
print(f"   Previous: 45% no-quote rate")
print(f"   Current:  {no_quotes}% no-quote rate")
print(f"   Improvement: {45 - no_quotes}% more trades classified")
